 ...
 <body class="bg-warning">
     ...
     <div class="container client text-center position-absolute">
         ...
         <span class="displa-4 text-uppercase d-block client_text pb-2 text-danger">Информациите беа успешно
             испратени.</span>
         <a href="../brainster_labs.html" class="h1 d-block text-decoration-none text-secondary client_text">Врати се на
             почеток</a>
     </div>
